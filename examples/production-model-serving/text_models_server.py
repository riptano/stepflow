...
async def model_health_check(input: ModelHealthInput) -> ModelHealthOutput:
    ...
    return ModelHealthOutput(
        ...
        gpu_available=HF_AVAILABLE and torch.cuda.is_available() if HF_AVAILABLE else False,
...
if __name__ == "__main__":
    ...
    logger.info(f"GPU available: {HF_AVAILABLE and torch.cuda.is_available() if HF_AVAILABLE else False}")
    ...
    if args.http:
        ...
        http_server.server.component(model_health_check)
        http_server.server.component(analyze_sentiment)
        http_server.server.component(generate_text)
        http_server.server.component(batch_process_text)
